...
Exposición HTTP planificada en OE-03-003B, issue #55. Recorrido web y búsqueda por código siguen pendientes de planificación. No se asignan números de issue ni puntos adicionales. La búsqueda por código depende de las credenciales QR.
